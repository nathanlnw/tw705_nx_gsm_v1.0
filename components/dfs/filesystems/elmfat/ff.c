...
ULONG sd_freesize(void)
{
    /*
         FATFS *fs;
      ULONG free_Capcity=0;
      FRESULT res;

     res=f_getfree ("0:", &free_Capcity,&fs);
    ...
    */
    ...
    rt_kprintf("%10lu KiB total drive space.\n%10lu KiB available.   fre_clust=%10lu  fs->csize=%10lu \n",
               tot_sect / 2, fre_sect / 2, fre_clust, fs->csize);
}
